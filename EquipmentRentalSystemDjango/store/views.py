...
def Feedback(request):
    if request.method == 'POST':
        ...
        ins = Feed(name=name, number=number, question1=question1, question2=question2, question3=question3, question4=question4, question5=question5, feedback=feedback)
        ins.save()
        print("ok")   
